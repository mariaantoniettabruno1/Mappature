!(function(e) {
  ...
  function a(n, t, r, l) {
    ...
    if (
      ...
      p = e("<tr/>").addClass("node-cells contracted");
    if (d > 3) p = e("<tr/>").addClass("node-cells");
    if ((c.append(i), p.append(c), o.append(p), h.length > 0)) {
      if (-1 == l.depth || r + 1 < l.depth) {
        ...
        f.append(u),
          ...
          o.append(f);
        var g = e("<tr/>").addClass(
          "draw_lines user" + h.length + " level" + r
        );
        if (
          (h.each(function() {
        ...
        var b = e("<tr/>").addClass("org-row child_box level-" + C);
        h.each(function() {
          var d = e("<td class='node-container'/>");
          d.attr("colspan", 2), a(e(this), d, r + 1, l), b.append(d);
        });
        var m = e("<tr/>").addClass("child_box_copy");
        h.each(function() {
          var d = e("<td class='node-container'/>");
          d.attr("colspan", 2), a(e(this), d, r + 1, l), m.append(d);
        });
      }
      o.append(b);
    }
    if (null != n.attr("class")) {
      var $ = n.attr("class").split(/\s+/);
      e.each($, function(e, d) {
        "collapsed" == d
    ...
    s.append(o), t.append(s), i.children("a").click(function(e) {});
  }
})(jQuery);
